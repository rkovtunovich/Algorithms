...
public static class DJP
{
    public static (Graph tree, double length) GetMST(Graph graph)
    {
        ...
        var minHeap = new HeapMin<double, Vertice>();
        var tree = new UndirectedVariableEdgeLengthGraph("MST");
        var treeEdges = new Dictionary<Vertice, (Vertice vertice, double length)>();
        ...
        var edges = new SimpleHashSet<Vertice>();
    ...
    private static void AddEdgesToHeap(HeapMin<double, (Vertice, Vertice)> heapMin, Graph graph, Vertice vertice, SimpleHashSet<Vertice> complited)
    {
