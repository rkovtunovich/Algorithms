...
public class SubsetSumProblem
{
    ...
    // The time complexity of the solution is O(n * TItem), where n is the number of jobs and TItem is the time capacity.
    // The space complexity of the solution is O(n * TItem).
    // Problem restatement:
    //      Given a set of jobs {J1, J2, ..., Jn} with processing times {P1, P2, ..., Pn} and a time capacity TItem,
    //      find a subset of jobs that maximizes the total processing time, while the total processing time does not exceed TItem.
