...
public static class LocalMatrixMinimum
{
    ...
    {
        if (rowEnd - rowStart is 0 && colEnd - colStart is 0)
        {
            mins.Add([rowStart, colStart, matrix[rowStart][colStart]]);
            return;
        }
        ...
        // finding the minimum value on the cross
        ...
        {
            mins.Add([middleRow, middleCol, min]);
            return;
        }
        ...
        // local minimum is on the cross
        if (quadrant is 0)
        {
            mins.Add([row, col, min]);
            return;
        }
